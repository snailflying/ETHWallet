...
import com.wallet.crypto.trustapp.util.WalletStorage
...
class GethKeystoreAccountService(private val keyStore: WalletStorage = WalletStorage.getInstance()) : AccountKeystoreService {
    ...
    override fun importKeystore(store: String, password: String, newPassword: String): Single<Wallet> {
        return Single.fromCallable {
    ...
    override fun exportAccount(wallet: Wallet, password: String, newPassword: String): Single<String> {
        return Single
    ...
    override fun signTransaction(signer: Wallet, signerPassword: String, toAddress: String, amount: BigInteger, gasPrice: BigInteger, gasLimit: BigInteger, nonce: Long, data: ByteArray, chainId: Long): Single<ByteArray> {
        return Single.fromCallable {
