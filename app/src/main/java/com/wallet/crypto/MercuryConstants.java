...
public abstract class MercuryConstants {
    ...
    public static final String DONATION_ADDRESS = "0x81f21492ae403dffa24ba1594e4b73b5e669543a";
    public static final String QQ_GROUP = "3P2GVcsBTTSVd8Vpow2KxfYmZaSn0Anf";
